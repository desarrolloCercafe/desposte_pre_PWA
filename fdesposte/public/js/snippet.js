...
function validaciones(){
    ...
    if(SelectCliente.value == 0){
        ...
        for (let index = 0; index < CantidadCiclos; index++) {
            ...
            //capturar variables
            var input =  document.getElementById("cantidad"+index);
...
function SaveData(){
    ...
    for (let index = 0; index < CantidadCiclos; index++) {
        ...
        var nombre = document.getElementById("nombre"+index);
        var cantidad = document.getElementById("cantidad"+index);
        var radio = document.getElementsByName("unidad"+index);
...
/*document.getElementById('addDesplegable').addEventListener('click', function(){
    console.log('jsdjsdj');
